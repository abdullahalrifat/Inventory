        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table" id="manageAccountingTable">
                        <thead>
                        <tr>
                            <th>Entry Name</th>
                            <th>Debit/Credit</th>
...
<script>
    ...
    function removeExpenseType(t,id) {
       //8alert(id);

        var rowNumber=$(t).closest('tr').index();
        var x = document.getElementById("manageAccountingTable").rows[rowNumber+1].cells;
        var EntryName=x[0].innerHTML;
        var EntryType=x[1].innerHTML;

        var r = confirm("Are You Sure To Delete "+EntryName+" Which is "+EntryType+"?");
        if (r == true) {
            $.ajax({
                type: 'POST',
